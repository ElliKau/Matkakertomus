...
app.get('/api/matkat', (req, res) => {
    ...
    db.query(query, function (error, result, fields) {
        ...
        if (error) {
            ...
            //kuvan hakeminen matkoille Elli tekee
...
app.post("/api/insert", (req, res) => { // Tällä voit tehdä POST requestin matkaaja tauluun
...
app.put("/update/:idmatkaaja", upload.array("file"), (req, res) => {
    ...
    //console.log("KUVATIEDOSTON NIMI ON: " + req.files[0].filename);
...
app.post("/api/insertTarina", upload.array("file"), (req, res) => {  //tällä olisi tarkoitus viedä tarina tauluun tietoja
...
app.put('/Updatetarina/:idtarina', upload.array("file"), (req, res) => {
    ...
    console.log("UPDATE tarina SET query:" + query);
